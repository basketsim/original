...
$reb1_oh=0; $reb2_oh=0; $ft1_oh=0; $ft2_oh=0;

//home team

$homepg1 = mysql_query("SELECT charac, height, weight, handling, speed, passing, vision, rebounds, position, freethrow, shooting, defense, workrate, experience, fatigue, wage FROM players WHERE id=$home_pg1");
...
$homepg1_wage=$aa["wage"];
}

$homesg1 = mysql_query("SELECT charac, height, weight, handling, speed, passing, vision, rebounds, position, freethrow, shooting, defense, workrate, experience, fatigue, wage FROM players WHERE id=$home_sg1");
...
$homesg1_wage=$aa["wage"];
}

$homesf1 = mysql_query("SELECT charac, height, weight, handling, speed, passing, vision, rebounds, position, freethrow, shooting, defense, workrate, experience, fatigue, wage FROM players WHERE id=$home_sf1");
...
$homesf1_wage=$aa["wage"];
}

$homepf1 = mysql_query("SELECT charac, height, weight, handling, speed, passing, vision, rebounds, position, freethrow, shooting, defense, workrate, experience, fatigue, wage FROM players WHERE id=$home_pf1");
...
$homepf1_wage=$aa["wage"];
}

$homec1 = mysql_query("SELECT charac, height, weight, handling, speed, passing, vision, rebounds, position, freethrow, shooting, defense, workrate, experience, fatigue, wage FROM players WHERE id=$home_c1");
...
if ($type==1) {
$homepg1_speed=round($homepg1_speed*1.04,2);
...
$homesg1_speed=round($homesg1_speed*1.04,2);
...
$homesf1_speed=round($homesf1_speed*1.04,2);
...
$homepf1_speed=round($homepf1_speed*1.04,2);
...
$homec1_speed=round($homec1_speed*1.04,2);
...
$homepg1_handling=$homepg1_handling+7;
$homepg1_speed=$homepg1_speed+7;
$homepg1_passing=$homepg1_passing+7;
$homepg1_vision=$homepg1_vision+7;
$homepg1_rebounds=$homepg1_rebounds+8;
$homepg1_position=$homepg1_position+7;
$homepg1_freethrow=$homepg1_freethrow+23;
$homepg1_shooting=$homepg1_shooting+9;
$homepg1_defense=$homepg1_defense+7;
$homepg1_experience=$homepg1_experience+3;
$homesg1_handling=$homesg1_handling+7;
$homesg1_speed=$homesg1_speed+7;
$homesg1_passing=$homesg1_passing+7;
$homesg1_vision=$homesg1_vision+7;
$homesg1_rebounds=$homesg1_rebounds+8;
$homesg1_position=$homesg1_position+7;
$homesg1_freethrow=$homesg1_freethrow+23;
$homesg1_shooting=$homesg1_shooting+9;
$homesg1_defense=$homesg1_defense+7;
$homesg1_experience=$homesg1_experience+3;
$homesf1_handling=$homesf1_handling+7;
$homesf1_speed=$homesf1_speed+7;
$homesf1_passing=$homesf1_passing+7;
$homesf1_vision=$homesf1_vision+7;
$homesf1_rebounds=$homesf1_rebounds+8;
$homesf1_position=$homesf1_position+7;
$homesf1_freethrow=$homesf1_freethrow+23;
$homesf1_shooting=$homesf1_shooting+6;
$homesf1_defense=$homesf1_defense+7;
$homesf1_experience=$homesf1_experience+3;
$homepf1_handling=$homepf1_handling+7;
$homepf1_speed=$homepf1_speed+7;
$homepf1_passing=$homepf1_passing+7;
$homepf1_vision=$homepf1_vision+7;
$homepf1_rebounds=$homepf1_rebounds+8;
$homepf1_position=$homepf1_position+7;
$homepf1_freethrow=$homepf1_freethrow+23;
$homepf1_shooting=$homepf1_shooting+6;
$homepf1_defense=$homepf1_defense+7;
$homepf1_experience=$homepf1_experience+3;
$homec1_handling=$homec1_handling+7;
$homec1_speed=$homec1_speed+7;
$homec1_passing=$homec1_passing+7;
$homec1_vision=$homec1_vision+7;
$homec1_rebounds=$homec1_rebounds+8;
$homec1_position=$homec1_position+7;
$homec1_freethrow=$homec1_freethrow+23;
$homec1_shooting=$homec1_shooting+6;
$homec1_defense=$homec1_defense+7;
$homec1_experience=$homec1_experience+3;
$awaypg1_handling=$awaypg1_handling+7;
$awaypg1_speed=$awaypg1_speed+7;
$awaypg1_passing=$awaypg1_passing+7;
$awaypg1_vision=$awaypg1_vision+7;
$awaypg1_rebounds=$awaypg1_rebounds+8;
$awaypg1_position=$awaypg1_position+7;
$awaypg1_freethrow=$awaypg1_freethrow+23;
$awaypg1_shooting=$awaypg1_shooting+9;
$awaypg1_defense=$awaypg1_defense+7;
$awaypg1_experience=$awaypg1_experience+3;
$awaysg1_handling=$awaysg1_handling+7;
$awaysg1_speed=$awaysg1_speed+7;
$awaysg1_passing=$awaysg1_passing+7;
$awaysg1_vision=$awaysg1_vision+7;
$awaysg1_rebounds=$awaysg1_rebounds+8;
$awaysg1_position=$awaysg1_position+7;
$awaysg1_freethrow=$awaysg1_freethrow+23;
$awaysg1_shooting=$awaysg1_shooting+9;
$awaysg1_defense=$awaysg1_defense+7;
$awaysg1_experience=$awaysg1_experience+3;
$awaysf1_handling=$awaysf1_handling+7;
$awaysf1_speed=$awaysf1_speed+7;
$awaysf1_passing=$awaysf1_passing+7;
$awaysf1_vision=$awaysf1_vision+7;
$awaysf1_rebounds=$awaysf1_rebounds+8;
$awaysf1_position=$awaysf1_position+7;
$awaysf1_freethrow=$awaysf1_freethrow+23;
$awaysf1_shooting=$awaysf1_shooting+6;
$awaysf1_defense=$awaysf1_defense+7;
$awaysf1_experience=$awaysf1_experience+3;
$awaypf1_handling=$awaypf1_handling+7;
$awaypf1_speed=$awaypf1_speed+7;
$awaypf1_passing=$awaypf1_passing+7;
$awaypf1_vision=$awaypf1_vision+7;
$awaypf1_rebounds=$awaypf1_rebounds+8;
$awaypf1_position=$awaypf1_position+7;
$awaypf1_freethrow=$awaypf1_freethrow+23;
$awaypf1_shooting=$awaypf1_shooting+6;
$awaypf1_defense=$awaypf1_defense+7;
$awaypf1_experience=$awaypf1_experience+3;
$awayc1_handling=$awayc1_handling+7;
$awayc1_speed=$awayc1_speed+7;
$awayc1_passing=$awayc1_passing+7;
$awayc1_vision=$awayc1_vision+7;
$awayc1_rebounds=$awayc1_rebounds+8;
$awayc1_position=$awayc1_position+7;
$awayc1_freethrow=$awayc1_freethrow+23;
$awayc1_shooting=$awayc1_shooting+6;
$awayc1_defense=$awayc1_defense+7;
$awayc1_experience=$awayc1_experience+3;
}
...
$homepg1_za_dve = round(98 - ($heightbonus + ($homepg1_speed/11) + ($homepg1_vision/15) + ($homepg1_position/8) + (sqrt($homepg1_shooting*4))*0.9 - ($homepg1_fatigue/2) + $addcharac - ($awaypg1_defense/9) - ((abs($homepg1_weight-83))/5)));
...
$awaypg1_za_dve = round(98 - ($heightbonus + ($awaypg1_speed/11) + ($awaypg1_vision/15) + ($awaypg1_position/8) + (sqrt($awaypg1_shooting*4))*0.9 - ($awaypg1_fatigue/2) + $addcharac - ($homepg1_defense/9) - ((abs($awaypg1_weight-83))/5)));
...
$homepg1_za_tri= 51-(($homepg1_speed/16) +($homepg1_position/14)+(sqrt($homepg1_shooting*4.5))+($homepg1_experience/7)-($homepg1_fatigue/2)+($homepg1_freethow/18) +$addcharac - ($awaypg1_defense/13));
...
$homesg1_za_tri= 51-(($homesg1_speed/16) +($homesg1_position/14)+(sqrt($homesg1_shooting*4.5))+($homesg1_experience/7)-($homesg1_fatigue/2)+($homesg1_freethow/18) +$addcharac - ($awaysg1_defense/13));
...
$homesf1_za_tri= 56-(($homesf1_speed/16)+($homesf1_position/14)+(sqrt($homesf1_shooting*4.5))+($homesf1_experience/7)-($homesf1_fatigue/2)+($homesf1_freethow/18) +$addcharac - ($awaysf1_defense/13));
...
$homepf1_za_tri= 58-(($homepf1_speed/16)+($homepf1_position/14)+(sqrt($homepf1_shooting*4.5))+($homepf1_experience/7)-($homepf1_fatigue/2)+($homepf1_freethow/18) +$addcharac - ($awaypf1_defense/13));
...
$awaypg1_za_tri= 51-(($awaypg1_speed/16)+($awaypg1_position/14)+(sqrt($awaypg1_shooting*4.5))+($awaypg1_experience/7)-($awaypg1_fatigue/2)+($awaypg1_freethow/18) +$addcharac - ($homepg1_defense/13));
...
$awaysg1_za_tri= 51-(($awaysg1_speed/16)+($awaysg1_position/14)+(sqrt($awaysg1_shooting*4.5))+($awaysg1_experience/7)-($awaysg1_fatigue/2)+($awaysg1_freethow/18) +$addcharac - ($homesg1_defense/13));
...
$awaysf1_za_tri= 56-(($awaysf1_speed/16)+($awaysf1_position/14)+(sqrt($awaysf1_shooting*4.5))+($awaysf1_experience/7)-($awaysf1_fatigue/2)+($awaysf1_freethow/18) +$addcharac - ($homesf1_defense/13));
...
$awaypf1_za_tri= 58-(($awaypf1_speed/16)+($awaypf1_position/14)+(sqrt($awaypf1_shooting*4.5))+($awaypf1_experience/7)-($awaypf1_fatigue/2)+($awaypf1_freethow/18) +$addcharac - ($homepf1_defense/13));
...
//FATIGUE
if ($home_def==0 OR $home_def==3) {$hom_def_fat=2;} else {$hom_def_fat=1;}
if ($away_def==0 OR $away_def==3) {$awa_def_fat=2;} else {$awa_def_fat=1;}
if ($home_off==0 OR $home_off==1) {$hom_off_fat=2;} else {$hom_off_fat=1;}
if ($away_off==0 OR $away_off==1) {$awa_off_fat=2;} else {$awa_off_fat=1;}

if ($type==1 || $type==3 || $type==4) {$typ_add_fat=4; $xp_add=0.39;}
if ($type==2) {$typ_add_fat=0; $xp_add=0.13;}
if ($type==6 ||$type==7) {$typ_add_fat=2; $xp_add=0.52;}

//wise extra xp
if ($homepg1_charac > 32 AND $homepg1_charac < 35) {$xch1 = 0.06;} else {$xch1 = 0;}
if ($homesg1_charac > 32 AND $homesg1_charac < 35) {$xch2 = 0.06;} else {$xch2 = 0;}
if ($homesf1_charac > 32 AND $homesf1_charac < 35) {$xch3 = 0.06;} else {$xch3 = 0;}
if ($homepf1_charac > 32 AND $homepf1_charac < 35) {$xch4 = 0.06;} else {$xch4 = 0;}
if ($homec1_charac > 32 AND $homec1_charac < 35) {$xch5 = 0.06;} else {$xch5 = 0;}
if ($awaypg1_charac > 32 AND $awaypg1_charac < 35) {$xch6 = 0.06;} else {$xch6 = 0;}
if ($awaysg1_charac > 32 AND $awaysg1_charac < 35) {$xch7 = 0.06;} else {$xch7 = 0;}
if ($awaysf1_charac > 32 AND $awaysf1_charac < 35) {$xch8 = 0.06;} else {$xch8 = 0;}
if ($awaypf1_charac > 32 AND $awaypf1_charac < 35) {$xch9 = 0.06;} else {$xch9 = 0;}
if ($awayc1_charac > 32 AND $awayc1_charac < 35) {$xch0 = 0.06;} else {$xch0 = 0;}

//tough less fatigue
if ($homepg1_charac > 38 AND $homepg1_charac < 41) {$tfat1 = -1;} else {$tfat1 = 0;}
if ($homesg1_charac > 38 AND $homesg1_charac < 41) {$tfat2 = -1;} else {$tfat2 = 0;}
if ($homesf1_charac > 38 AND $homesf1_charac < 41) {$tfat3 = -1;} else {$tfat3 = 0;}
if ($homepf1_charac > 38 AND $homepf1_charac < 41) {$tfat4 = -1;} else {$tfat4 = 0;}
if ($homec1_charac > 38 AND $homec1_charac < 41) {$tfat5 = -1;} else {$tfat5 = 0;}
if ($awaypg1_charac > 38 AND $awaypg1_charac < 41) {$tfat6 = -1;} else {$tfat6 = 0;}
if ($awaysg1_charac > 38 AND $awaysg1_charac < 41) {$tfat7 = -1;} else {$tfat7 = 0;}
if ($awaysf1_charac > 38 AND $awaysf1_charac < 41) {$tfat8 = -1;} else {$tfat8 = 0;}
if ($awaypf1_charac > 38 AND $awaypf1_charac < 41) {$tfat9 = -1;} else {$tfat9 = 0;}
if ($awayc1_charac > 38 AND $awayc1_charac < 41) {$tfat0 = -1;} else {$tfat0 = 0;}

if ($type < 5) {
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch1, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat+$tfat1, has_played=1, star_qual=$hpgzvezd, star_posit=1 WHERE id=$home_pg1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch2, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat+$tfat2, has_played=1, star_qual=$hsgzvezd, star_posit=2 WHERE id=$home_sg1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch3, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat+$tfat3, has_played=1, star_qual=$hsfzvezd, star_posit=3 WHERE id=$home_sf1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch4, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat+$tfat4, has_played=1, star_qual=$hpfzvezd, star_posit=4 WHERE id=$home_pf1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch5, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat+$tfat5, has_played=1, star_qual=$hczvezd, star_posit=5 WHERE id=$home_c1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch6, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat+$tfat6, has_played=1, star_qual=$apgzvezd, star_posit=1 WHERE id=$away_pg1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch7, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat+$tfat7, has_played=1, star_qual=$asgzvezd, star_posit=2 WHERE id=$away_sg1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch8, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat+$tfat8, has_played=1, star_qual=$asfzvezd, star_posit=3 WHERE id=$away_sf1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch9, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat+$tfat9, has_played=1, star_qual=$apfzvezd, star_posit=4 WHERE id=$away_pf1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add+$xch0, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat+$tfat0, has_played=1, star_qual=$aczvezd, star_posit=5 WHERE id=$away_c1 LIMIT 1");
}
if ($type > 5 AND $type < 8) {
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat, star_qual=$hpgzvezd, star_posit=1 WHERE id=$home_pg1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat, star_qual=$hsgzvezd, star_posit=2 WHERE id=$home_sg1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat, star_qual=$hsfzvezd, star_posit=3 WHERE id=$home_sf1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat, star_qual=$hpfzvezd, star_posit=4 WHERE id=$home_pf1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$hom_def_fat+$hom_off_fat+$typ_add_fat, star_qual=$hczvezd, star_posit=5 WHERE id=$home_c1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat, star_qual=$apgzvezd, star_posit=1 WHERE id=$away_pg1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat, star_qual=$asgzvezd, star_posit=2 WHERE id=$away_sg1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat, star_qual=$asfzvezd, star_posit=3 WHERE id=$away_sf1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat, star_qual=$apfzvezd, star_posit=4 WHERE id=$away_pf1 LIMIT 1");
mysql_query("UPDATE players SET experience=experience+$xp_add, fatigue=fatigue+$awa_def_fat+$awa_off_fat+$typ_add_fat, star_qual=$aczvezd, star_posit=5 WHERE id=$away_c1 LIMIT 1");
}
if ($type==5 OR $type==18) {
mysql_query("UPDATE players SET star_qual=$hpgzvezd, star_posit=1 WHERE id=$home_pg1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$hsgzvezd, star_posit=2 WHERE id=$home_sg1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$hsfzvezd, star_posit=3 WHERE id=$home_sf1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$hpfzvezd, star_posit=4 WHERE id=$home_pf1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$hczvezd, star_posit=5 WHERE id=$home_c1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$apgzvezd, star_posit=1 WHERE id=$away_pg1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$asgzvezd, star_posit=2 WHERE id=$away_sg1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$asfzvezd, star_posit=3 WHERE id=$away_sf1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$apfzvezd, star_posit=4 WHERE id=$away_pf1 LIMIT 1");
mysql_query("UPDATE players SET star_qual=$aczvezd, star_posit=5 WHERE id=$away_c1 LIMIT 1");
}
if ($type==19) {
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat1, star_qual=$hpgzvezd, star_posit=1 WHERE id=$home_pg1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat2, star_qual=$hsgzvezd, star_posit=2 WHERE id=$home_sg1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat3, star_qual=$hsfzvezd, star_posit=3 WHERE id=$home_sf1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat4, star_qual=$hpfzvezd, star_posit=4 WHERE id=$home_pf1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat5, star_qual=$hczvezd, star_posit=5 WHERE id=$home_c1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat6, star_qual=$apgzvezd, star_posit=1 WHERE id=$away_pg1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat7, star_qual=$asgzvezd, star_posit=2 WHERE id=$away_sg1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat8, star_qual=$asfzvezd, star_posit=3 WHERE id=$away_sf1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat9, star_qual=$apfzvezd, star_posit=4 WHERE id=$away_pf1 LIMIT 1");
mysql_query("UPDATE players SET fatigue=fatigue+4+$tfat0, star_qual=$aczvezd, star_posit=5 WHERE id=$away_c1 LIMIT 1");
}
...
mysql_query("UPDATE `matches` SET `hpg_rating` =$hpgzvezd, `hsg_rating` =$hsgzvezd, `hsf_rating` =$hsfzvezd, `hpf_rating` =$hpfzvezd, `hc_rating` =$hczvezd, `apg_rating` =$apgzvezd, `asg_rating` =$asgzvezd, `asf_rating` =$asfzvezd, `apf_rating` =$apfzvezd, `ac_rating` =$aczvezd, h2p = '$homesk2', a2p = '$awaysk2', h3p = '$homesk3', a3p = '$awaysk3', hreb = $homeoffskok + $homedefskok, areb = $awayoffskok + $awaydefskok, hto = $hometo, ato = $awayto, htir = '$homefat', atir = '$awayfat' WHERE `matchid`=$matchid LIMIT 1");

//poskodbe
$antiposkodbe=0;
$medicine = mysql_query("SELECT current_level FROM medical_center WHERE id_team=$home_id");
if (mysql_fetch_row($medicine)) {$antiposkodbe = mysql_result($medicine,0);} else {$antiposkodbe=0;}
if ($type==5 OR $type==18 OR $type==19) {$antiposkodbe=7;}
$slabokaze = ($antiposkodbe*($antiposkodbe-1)*150) + 750;
$slabokaze2 = $slabokaze-1;

$dom_vrednost=0; $gos_vrednost=0;
$domizku = mysql_query("SELECT `experience` FROM `players` WHERE `coach`=1 AND `club`='$home_id' LIMIT 1");
if (mysql_num_rows($domizku)>0) {$domkovc = mysql_result($domizku,0); $dom_vrednost = round($domkovc/8,2);}
$gosizku = mysql_query("SELECT `experience` FROM `players` WHERE `coach` =1 AND `club`='$away_id' LIMIT 1");
if (mysql_num_rows($gosizku)>0) {$goskovc = mysql_result($gosizku,0); $gos_vrednost = round($goskovc/8,2);}

//bonus na proste mete
$homepg1_freethrow=round($homepg1_freethrow + $dom_vrednost - 0.4*$homepg1_fatigue);
$homesg1_freethrow=round($homesg1_freethrow + $dom_vrednost - 0.4*$homesg1_fatigue);
$homesf1_freethrow=round($homesf1_freethrow + $dom_vrednost - 0.4*$homesf1_fatigue);
$homepf1_freethrow=round($homepf1_freethrow + $dom_vrednost - 0.4*$homepf1_fatigue);
$homec1_freethrow=round($homec1_freethrow + $dom_vrednost - 0.4*$homec1_fatigue);
$awaypg1_freethrow=round($awaypg1_freethrow + $gos_vrednost - 0.4*$awaypg1_fatigue);
$awaysg1_freethrow=round($awaysg1_freethrow + $gos_vrednost - 0.4*$awaysg1_fatigue);
$awaysf1_freethrow=round($awaysf1_freethrow + $gos_vrednost - 0.4*$awaysf1_fatigue);
$awaypf1_freethrow=round($awaypf1_freethrow + $gos_vrednost - 0.4*$awaypf1_fatigue);
$awayc1_freethrow=round($awayc1_freethrow + $gos_vrednost - 0.4*$awayc1_fatigue);

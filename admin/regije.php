...
$dayz=$_GET['dayz'];
if ($dayz=='nat') {mysql_query("INSERT INTO messages VALUES ('', 1, 0, 0, NOW(), 'Naturalization', '<a href=player.php?playerid=$playerid>link</a>')"); header("Location: player.php?playerid=$playerid&dayz=off");}
if ($dayz=='on') {
...
//naturalizacija
if ($timeof > 1094 AND $coach==0 AND $ntplayer==0) {
...
<?php
//if ($club==$trueclub AND $playerid < 4203212){echo " <a href=\"player.php?playerid=",$playerid,"&next=EV\" class=\"greenhilite\" title=\"EV drop info\"><font color=\"green\">[?]</font></a>";}
}
...
elseif ($handling > 112 AND $handling < 121) {$handling_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $handling_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($speed > 112 AND $speed < 121) {$speed_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $speed_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($passing > 112 AND $passing < 121) {$passing_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $passing_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($vision > 112 AND $vision < 121) {$vision_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $vision_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($rebounds > 112 AND $rebounds < 121) {$rebounds_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $rebounds_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($position > 112 AND $position < 121) {$position_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $position_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($shooting > 112 AND $shooting < 121) {$shooting_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $shooting_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($freethrow > 112 AND $freethrow < 121) {$freethrow_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $freethrow_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($defense > 112 AND $defense < 121) {$defense_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $defense_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";
...
elseif ($workrate > 112 AND $workrate < 121) {$workrate_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; $gmwr=14;}
else {$workrate_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>"; $gmwr=15;}
...
elseif ($experience > 112 AND $experience < 121) {$experience_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=14\">".$langmark109."</a>"; }
else $experience_dspl = "<a class=\"greenhilite\" href=\"gamerules.php?action=denominations&color=15\">".$langmark110."</a>";

if ($coach==9) {
if ($handling==0 AND $spec_txt==$langmark763) {$handling_dspl = "<font color=#009900>unknown</font>"; $lk=4;} elseif ($handling==0) {$handling_dspl = "<i>unknown</i>";}
if ($speed==0 AND $spec_txt==$langmark765) {$speed_dspl = "<font color=#A30006>unknown</font>"; $lk=4;} elseif ($speed==0) {$speed_dspl = "<i>unknown</i>";}
if ($passing==0 AND $spec_txt==$langmark768) {$passing_dspl = "<font color=#A30006>unknown</font>"; $lk=4;} elseif ($passing==0) {$passing_dspl = "<i>unknown</i>";}
if ($vision==0 AND ($spec_txt==$langmark764 OR $spec_txt==$langmark768)) {$vision_dspl = "<font color=#009900>unknown</font>"; $lk=4;} elseif ($vision==0) {$vision_dspl = "<i>unknown</i>";}
if ($rebounds==0 AND $spec_txt==$langmark766) {$rebounds_dspl = "<font color=#009900>unknown</font>"; $lk=4;} elseif ($rebounds==0) {$rebounds_dspl = "<i>unknown</i>";}
if ($position==0 AND $spec_txt==$langmark767) {$position_dspl = "<font color=#A30006>unknown</font>"; $lk=4;} elseif ($position==0) {$position_dspl = "<i>unknown</i>";}
if ($shooting==0 AND ($spec_txt==$langmark765 OR $spec_txt==$langmark768)) {$shooting_dspl = "<font color=#009900>unknown</font>"; $lk=4;} elseif ($shooting==0) {$shooting_dspl = "<i>unknown</i>";}
if ($freethrow==0 AND $spec_txt==$langmark763) {$freethrow_dspl = "<font color=#009900>unknown</font>"; $lk=4;} elseif ($freethrow==0) {$freethrow_dspl = "<i>unknown</i>";}
if ($defense==0 AND $spec_txt==$langmark768) {$defense_dspl = "<font color=#A30006>unknown</font>"; $lk=4;} elseif ($defense==0) {$defense_dspl = "<i>unknown</i>";}
...
<tr><td colspan="2" style="border-top: solid 1px LightSteelBlue;"></td></tr>
<!--<tr><td colspan="2">All 17 year olds will be autopromoted in less than 4 weeks!</td></tr>-->
<!--<tr><td colspan="2">17 year olds will be autopromoted in few days time.</td></tr>-->
<tr><td colspan="2">17 year olds will be autopromoted in 10 weeks, so plan their training accordingly!</td></tr>
<tr><td colspan="2" style="border-bottom: solid 1px LightSteelBlue;"></td></tr>
</table>
<?php
}
break;
case ($clubus == $userid AND $coach<>9):
/* v tem primeru obrazec, ki omogoci prodajo igralca */
?>

<h2><?=$langmark448?></h2><br/>
<?php
$posit = $_POST['posit'];
$pric = $_POST['pric'];
$stime = $_POST['stime'];
...
//primerjam postavljeno ceno in vrednost igralca krat 2
...
/* konec obrazca, ki omogoci prodajo igralca */
...
if ($levelll >2 AND $club <> $trueclub AND $coach<>9) {echo "<a href=\"admin/transfers.php?player=",$playerid,"\"><font color=\"darkred\">Price adjustment</font></a> <font color=\"darkred\">(WR=",$gmwr,")</font>";}

...
if (!is_numeric($playerid)) {die(include 'basketsim.php');}
...
$levelll = mysql_result($compare,0,"level");
}
else {die(include 'basketsim.php');}
if ($is_supporter<>1) {header("Location: player.php?playerid=$playerid"); die();}
require("inc/lang/".$lang.".php");

$ex=$_GET['ex'];
if ($ex<>'yes') {$result = mysql_query("SELECT * FROM players WHERE coach<>9 AND id='$playerid' LIMIT 1");
...
$result17 = mysql_query("SELECT userid FROM users WHERE club ='$club' LIMIT 1");
if (mysql_num_rows($result17) >0) {$clubus = mysql_result($result17,0,"userid");}
...
<?php
$tiptop = mysql_query("SELECT `match`, 2*statistics.two_scored+statistics.one_scored+statistics.three_scored*3 AS scored FROM statistics, matches WHERE `match` = matchid AND statistics.type <>2 AND statistics.type <>5 AND statistics.type <>18 AND statistics.type <>19 AND player ='$playerid' ORDER BY 2*statistics.two_scored+statistics.one_scored+statistics.three_scored*3 DESC, gametime ASC LIMIT 1") or die(mysql_error());
if (mysql_num_rows($tiptop)) {
$topscored = mysql_result($tiptop,0,"match");
$topscores = mysql_result($tiptop,0,"scored");
}
$tiptop1 = mysql_query("SELECT `match`, def_rebounds+off_rebounds AS scored FROM statistics, matches WHERE `match` = matchid AND statistics.type <>2 AND statistics.type <>5 AND statistics.type <>18 AND statistics.type <>19 AND player ='$playerid' ORDER BY def_rebounds+off_rebounds DESC, gametime ASC LIMIT 1") or die(mysql_error());
if (mysql_num_rows($tiptop1)) {
$topscored1 = mysql_result($tiptop1,0,"match");
$topscores1 = mysql_result($tiptop1,0,"scored");
}
$tiptop2 = mysql_query("SELECT `match`, assists AS scored FROM statistics, matches WHERE `match` = matchid AND statistics.type <>2 AND statistics.type <>5 AND statistics.type <>18 AND statistics.type <>19 AND player ='$playerid' ORDER BY assists DESC, gametime ASC LIMIT 1") or die(mysql_error());
if (mysql_num_rows($tiptop2)) {
$topscored2 = mysql_result($tiptop2,0,"match");
$topscores2 = mysql_result($tiptop2,0,"scored");
}
$tiptop3 = mysql_query("SELECT `match`, statistics.steals AS scored FROM statistics, matches WHERE `match` = matchid AND statistics.type <>2 AND statistics.type <>5 AND statistics.type <>18 AND statistics.type <>19 AND player ='$playerid' ORDER BY steals DESC, gametime ASC LIMIT 1") or die(mysql_error());
if (mysql_num_rows($tiptop3)) {
$topscored3 = mysql_result($tiptop3,0,"match");
$topscores3 = mysql_result($tiptop3,0,"scored");
}
$tiptop4 = mysql_query("SELECT `match`, blocks AS scored FROM statistics, matches WHERE `match` = matchid AND statistics.type <>2 AND statistics.type <>5 AND statistics.type <>18 AND statistics.type <>19 AND player ='$playerid' ORDER BY blocks DESC, gametime ASC LIMIT 1") or die(mysql_error());
if (mysql_num_rows($tiptop4)) {
$topscored4 = mysql_result($tiptop4,0,"match");
$topscores4 = mysql_result($tiptop4,0,"scored");
}
$tiptop5 = mysql_query("SELECT `match`, turnovers AS scored FROM statistics, matches WHERE `match` = matchid AND statistics.type <>2 AND statistics.type <>5 AND statistics.type <>18 AND statistics.type <>19 AND player ='$playerid' ORDER BY turnovers DESC, gametime ASC LIMIT 1") or die(mysql_error());
if (mysql_num_rows($tiptop5)) {
$topscored5 = mysql_result($tiptop5,0,"match");
$topscores5 = mysql_result($tiptop5,0,"scored");
}
$tiptop6 = mysql_query("SELECT `match`, three_scored AS scored FROM statistics, matches WHERE `match` = matchid AND statistics.type <>2 AND statistics.type <>5 AND statistics.type <>18 AND statistics.type <>19 AND player ='$playerid' ORDER BY three_scored DESC, three_total ASC, gametime ASC LIMIT 1") or die(mysql_error());
if (mysql_num_rows($tiptop6)) {
$topscored6 = mysql_result($tiptop6,0,"match");
$topscores6 = mysql_result($tiptop6,0,"scored");
}
$tiptop7 = mysql_query("SELECT `match`, (( 2 * `two_scored` + `one_scored` + `three_scored` *3 ) - ( `two_total` - `two_scored` ) - ( `one_total` - `one_scored` ) - ( `three_total` - `three_scored` ) + `def_rebounds` + `off_rebounds` + `blocks` + `steals` + `assists` - `turnovers`) AS scored FROM statistics, matches WHERE `match` = matchid AND statistics.type <>2 AND statistics.type <>5 AND statistics.type <>18 AND statistics.type <>19 AND (( 2 * `two_scored` + `one_scored` + `three_scored` *3 ) - ( `two_total` - `two_scored` ) - ( `one_total` - `one_scored` ) - ( `three_total` - `three_scored` ) + `def_rebounds` + `off_rebounds` + `blocks` + `steals` + `assists` - `turnovers`) <1000 AND player ='$playerid' ORDER BY scored DESC , gametime ASC LIMIT 1") or die(mysql_error());
if (mysql_num_rows($tiptop7)) {
$topscored7 = mysql_result($tiptop7,0,"match");
$topscores7 = mysql_result($tiptop7,0,"scored");
}

$tiptopB0 = @mysql_query("SELECT * FROM statistics WHERE type <>2 AND type <>5 AND type<>18 AND type<>19 AND `player` ='$playerid'") or die(mysql_error());
$playedB = @mysql_num_rows($tiptopB0);
$tiptopB = mysql_query("SELECT SUM(2*two_scored+one_scored+three_scored*3) AS scored FROM statistics WHERE type <>2 AND type <>5 AND type<>18 AND type<>19 AND `player` ='$playerid'") or die(mysql_error());
if (mysql_num_rows($tiptopB) >0) {$topscoresB = mysql_result($tiptopB,0,"scored");}
$tiptopB1 = mysql_query("SELECT SUM(def_rebounds+off_rebounds) AS scored FROM statistics WHERE type <>2 AND type <>5 AND type<>18 AND type<>19 AND `player` ='$playerid'") or die(mysql_error());
if (mysql_num_rows($tiptopB1) >0) {$topscoresB1 = mysql_result($tiptopB1,0,"scored");}
$tiptopB2 = mysql_query("SELECT SUM(assists) AS scored FROM statistics WHERE type <>2 AND type <>5 AND type<>18 AND type<>19 AND `player` ='$playerid'") or die(mysql_error());
if (mysql_num_rows($tiptopB2) >0) {$topscoresB2 = mysql_result($tiptopB2,0,"scored");}
$tiptopB3 = mysql_query("SELECT SUM(steals) AS scored FROM statistics WHERE type <>2 AND type <>5 AND type<>18 AND type<>19 AND `player` ='$playerid'") or die(mysql_error());
if (mysql_num_rows($tiptopB3) >0) {$topscoresB3 = mysql_result($tiptopB3,0,"scored");}
$tiptopB4 = mysql_query("SELECT SUM(blocks) AS scored FROM statistics WHERE type <>2 AND type <>5 AND type<>18 AND type<>19 AND `player` ='$playerid'") or die(mysql_error());
if (mysql_num_rows($tiptopB4) >0) {$topscoresB4 = mysql_result($tiptopB4,0,"scored");}
$tiptopB5 = mysql_query("SELECT SUM(turnovers) AS scored FROM statistics WHERE type <>2 AND type <>5 AND type<>18 AND type<>19 AND `player` ='$playerid'") or die(mysql_error());
if (mysql_num_rows($tiptopB5) >0) {$topscoresB5 = mysql_result($tiptopB5,0,"scored");}
$tiptopB6 = mysql_query("SELECT SUM(three_scored) AS scored FROM statistics WHERE type <>2 AND type <>5 AND type<>18 AND type<>19 AND `player` ='$playerid'") or die(mysql_error());
if (mysql_num_rows($tiptopB6) >0) {$topscoresB6 = mysql_result($tiptopB6,0,"scored");}
?>

<table cellpadding="1" cellspacing="1" width="99%">
<tr><td colspan="2"><b>Career highs</b><hr/></td></tr>
<?php if($topscores >0){?><tr><td><?=$langmark807?> <a href="prikaz.php?matchid=<?=$topscored?>"><?=$langmark814?></a>:</td><td align="right"><?=$topscores?></td></tr><?php }?>
<?php if($topscores6 >0){?><tr><td><?=$langmark808?> <a href="prikaz.php?matchid=<?=$topscored6?>"><?=$langmark814?></a>:</td><td align="right"><?=$topscores6?></td></tr><?php }?>
<?php if($topscores1 >0){?><tr><td><?=$langmark809?> <a href="prikaz.php?matchid=<?=$topscored1?>"><?=$langmark814?></a>:</td><td align="right"><?=$topscores1?></td></tr><?php }?>
<?php if($topscores2 >0){?><tr><td><?=$langmark810?> <a href="prikaz.php?matchid=<?=$topscored2?>"><?=$langmark814?></a>:</td><td align="right"><?=$topscores2?></td></tr><?php }?>
<?php if($topscores3 >0){?><tr><td><?=$langmark811?> <a href="prikaz.php?matchid=<?=$topscored3?>"><?=$langmark814?></a>:</td><td align="right"><?=$topscores3?></td></tr><?php }?>
<?php if($topscores4 >0){?><tr><td><?=$langmark812?> <a href="prikaz.php?matchid=<?=$topscored4?>"><?=$langmark814?></a>:</td><td align="right"><?=$topscores4?></td></tr><?php }?>
<?php if($topscores5 >0){?><tr><td><?=$langmark813?> <a href="prikaz.php?matchid=<?=$topscored5?>"><?=$langmark814?></a>:</td><td align="right"><?=$topscores5?></td></tr><?php }?>
<?php if($topscores7 >0){?><tr><td><?=$langmark1289?> <a href="prikaz.php?matchid=<?=$topscored7?>"><?=$langmark814?></a>:</td><td align="right"><?=$topscores7?></td></tr><?php }?>
</table>
<br/>
<table cellpadding="1" cellspacing="1" width="99%">
<?php
$ad = $_GET["a"];
if ($ad=='d') {?>
<tr><td colspan="2"><b>Career totals</b> (<a href="personal.php?playerid=<?=$playerid?>">per match</a>)<hr/></td></tr>


<?php if($topscoresB >0){?><tr><td>Career points:</td><td align="right"><?=number_format($topscoresB/$playedB,1)?></td></tr><?php }?>
<?php if($topscoresB6 >0){?><tr><td>Career 3-pointers:</td><td align="right"><?=number_format($topscoresB6/$playedB,1)?></td></tr><?php }?>
<?php if($topscoresB1 >0){?><tr><td>Career rebounds:</td><td align="right"><?=number_format($topscoresB1/$playedB,1)?></td></tr><?php }?>
<?php if($topscoresB2 >0){?><tr><td>Career assists:</td><td align="right"><?=number_format($topscoresB2/$playedB,1)?></td></tr><?php }?>
<?php if($topscoresB3 >0){?><tr><td>Career steals:</td><td align="right"><?=number_format($topscoresB3/$playedB,1)?></td></tr><?php }?>
<?php if($topscoresB4 >0){?><tr><td>Career blocks:</td><td align="right"><?=number_format($topscoresB4/$playedB,1)?></td></tr><?php }?>
<?php if($topscoresB5 >0){?><tr><td>Career turnovers:</td><td align="right"><?=number_format($topscoresB5/$playedB,1)?></td></tr><?php }?>
<?php } else {?>
<tr><td colspan="2"><b>Career totals</b> (<a href="personal.php?playerid=<?=$playerid?>&a=d"><?=$playedB?> <?=$langmark1259?></a>)<hr/></td></tr>
<?php if($topscoresB >0){?><tr><td>Career points:</td><td align="right"><?=$topscoresB?></td></tr><?php }?>
<?php if($topscoresB6 >0){?><tr><td>Career 3-pointers:</td><td align="right"><?=$topscoresB6?></td></tr><?php }?>
<?php if($topscoresB1 >0){?><tr><td>Career rebounds:</td><td align="right"><?=$topscoresB1?></td></tr><?php }?>
<?php if($topscoresB2 >0){?><tr><td>Career assists:</td><td align="right"><?=$topscoresB2?></td></tr><?php }?>
<?php if($topscoresB3 >0){?><tr><td>Career steals:</td><td align="right"><?=$topscoresB3?></td></tr><?php }?>
<?php if($topscoresB4 >0){?><tr><td>Career blocks:</td><td align="right"><?=$topscoresB4?></td></tr><?php }?>
<?php if($topscoresB5 >0){?><tr><td>Career turnovers:</td><td align="right"><?=$topscoresB5?></td></tr><?php }?>
<?php }?>
</table>

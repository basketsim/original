<?php
/*
pri bivših cup prvakih still in cup!
avg obisk na pokalno stran..
still in cup 1.1 zamik
legenda kaj pomeni kaj

online za vse? bolj vidno?!!  ++uses left in cup, mogoče supp  ...  vidno št online!?!
v pokalu izpis rand tudi za nenastavljene tekme?!

klikabilna cela vrstica & lepš prikaz rezultata(+greenhilite) ; zaostrim rand izpis+supp ; večje arene? ; mr izboljšave ; obarvan svoj klub ; pri 1/2F oznaka razlik vs cws ; odds ; userji online zame ; pri tekmah dresi - majhni clo pri ligah
ime nac pokala opcija? vsaj prikaz na league.php (spreminja mod?) ; klikabilna sezona past winnerji ; stare pokalne tekme linki na nove ekipe!  ;  cup exit msg: kdaj nagrade & čestitka & opportunity (flags, trening) ; označ ex winerje
tekme za zadnje kroge razširim z dod info +razni stats, največ pokalnih zmag, naj cup ekipe, največ za 1 piko, največ za 1 piko v 1 sezoni (skupna stran za pokale) ; cup mvp (dod tabela) ; cup rekordi! (dod tabela, tud za lige itd)
*/
...
} else {echo "<br/><hr/><br/><b>National cup MVP award:</b> <i>retired player</i>";}
}

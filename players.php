...
//players številke - ko dodajam nove pogledam če kdo že ma in jim odstranim
$preveter = mysql_query("SELECT id FROM players WHERE shirt >0 AND shirt ='$numigraca' AND coach=0 AND club ='$get_team'") or die(mysql_error());
if (!(mysql_num_rows($preveter)>0)) {mysql_query("UPDATE players SET shirt ='$numigraca' WHERE coach=0 AND id ='$idigraca' LIMIT 1") or die(mysql_error());}
$ko++;
}
header("Location: players.php?changenow=numbers");
}

$sort = $_POST['sort'];
if (strlen($sort)>10) {$sort=NULL;}
if (!$sort || $sort=='shirt') {$result = mysql_query("SELECT *, IF (shirt IS NULL || shirt ='' || shirt=0, 1, 0) AS isnull FROM players WHERE club ='$get_team' AND coach=0 ORDER BY isnull ASC, shirt ASC, wage DESC");}
elseif ($sort=='age') {$result = mysql_query("SELECT * FROM players WHERE coach=0 AND club='$get_team' ORDER BY age ASC") or die(mysql_error());}
elseif ($sort=='skillsum') {$result = mysql_query("SELECT * FROM players WHERE coach=0 AND club='$get_team' ORDER BY `handling` + `speed` + `passing` + `vision` + `rebounds` + `position` + `freethrow` + `shooting` + `defense` DESC") or die(mysql_error());}
elseif ($sort=='height' OR $sort=='weight' OR $sort=='handling' OR $sort=='speed' OR $sort=='passing' OR $sort=='vision' OR $sort=='rebounds' OR $sort=='position' OR $sort=='shooting' OR $sort=='freethrow' OR $sort=='defense' OR $sort=='experience' OR $sort=='workrate' OR $sort=='fatigue' OR $sort=='wage') {$result = mysql_query("SELECT * FROM players WHERE coach=0 AND club='$get_team' ORDER BY $sort DESC") or die(mysql_error());}
elseif ($sort=='training') {$result = mysql_query("SELECT * FROM players WHERE coach=0 AND club=$get_team AND last_position > 0 ORDER BY last_training DESC") or die(mysql_error());}
//if ($get_team==12828 AND $userid==28225) {$result = mysql_query("SELECT * FROM players WHERE  ... abd coach=0 order by wage desc limit 499") or die(mysql_error());}
...
elseif ($handling > 112 AND $handling < 121 AND $lang != 'isr') {$handling_dspl = $langmark1584." (14)";}
elseif ($handling > 120 AND $handling < 129 AND $lang != 'isr') {$handling_dspl = $langmark1585." (15)";}
elseif ($handling > 128 AND $handling < 137 AND $lang != 'isr') {$handling_dspl = $langmark1586." (16)";}
elseif ($handling > 136 AND $handling < 145 AND $lang != 'isr') {$handling_dspl = $langmark1587." (17)";}
elseif ($handling > 144 AND $handling < 153 AND $lang != 'isr') {$handling_dspl = $langmark1588." (18)";}
elseif ($handling > 152 AND $handling < 161 AND $lang != 'isr') {$handling_dspl = $langmark109." (19)";}
elseif ($handling >= 161 AND $lang != 'isr') {$handling_dspl = $langmark110." (20)";}
...
elseif ($speed > 112 AND $speed < 121 AND $lang != 'isr') {$speed_dspl = $langmark1584." (14)";}
elseif ($speed > 120 AND $speed < 129 AND $lang != 'isr') {$speed_dspl = $langmark1585." (15)";}
elseif ($speed > 128 AND $speed < 137 AND $lang != 'isr') {$speed_dspl = $langmark1586." (16)";}
elseif ($speed > 136 AND $speed < 145 AND $lang != 'isr') {$speed_dspl = $langmark1587." (17)";}
elseif ($speed > 144 AND $speed < 153 AND $lang != 'isr') {$speed_dspl = $langmark1588." (18)";}
elseif ($speed > 152 AND $speed < 161 AND $lang != 'isr') {$speed_dspl = $langmark109." (19)";}
elseif ($speed >= 161 AND $lang != 'isr') {$speed_dspl = $langmark110." (20)";}
...
elseif ($passing > 112 AND $passing < 121 AND $lang != 'isr') {$passing_dspl = $langmark1584." (14)";}
elseif ($passing > 120 AND $passing < 129 AND $lang != 'isr') {$passing_dspl = $langmark1585." (15)";}
elseif ($passing > 128 AND $passing < 137 AND $lang != 'isr') {$passing_dspl = $langmark1586." (16)";}
elseif ($passing > 136 AND $passing < 145 AND $lang != 'isr') {$passing_dspl = $langmark1587." (17)";}
elseif ($passing > 144 AND $passing < 153 AND $lang != 'isr') {$passing_dspl = $langmark1588." (18)";}
elseif ($passing > 152 AND $passing < 161 AND $lang != 'isr') {$passing_dspl = $langmark109." (19)";}
elseif ($passing >= 161 AND $lang != 'isr') {$passing_dspl = $langmark110." (20)";}
...
elseif ($vision > 112 AND $vision < 121 AND $lang != 'isr') {$vision_dspl = $langmark1584." (14)";}
elseif ($vision > 120 AND $vision < 129 AND $lang != 'isr') {$vision_dspl = $langmark1585." (15)";}
elseif ($vision > 128 AND $vision < 137 AND $lang != 'isr') {$vision_dspl = $langmark1586." (16)";}
elseif ($vision > 136 AND $vision < 145 AND $lang != 'isr') {$vision_dspl = $langmark1587." (17)";}
elseif ($vision > 144 AND $vision < 153 AND $lang != 'isr') {$vision_dspl = $langmark1588." (18)";}
elseif ($vision > 152 AND $vision < 161 AND $lang != 'isr') {$vision_dspl = $langmark109." (19)";}
elseif ($vision >= 161 AND $lang != 'isr') {$vision_dspl = $langmark110." (20)";}
...
elseif ($rebounds > 112 AND $rebounds < 121 AND $lang != 'isr') {$rebounds_dspl = $langmark1584." (14)";}
elseif ($rebounds > 120 AND $rebounds < 129 AND $lang != 'isr') {$rebounds_dspl = $langmark1585." (15)";}
elseif ($rebounds > 128 AND $rebounds < 137 AND $lang != 'isr') {$rebounds_dspl = $langmark1586." (16)";}
elseif ($rebounds > 136 AND $rebounds < 145 AND $lang != 'isr') {$rebounds_dspl = $langmark1587." (17)";}
elseif ($rebounds > 144 AND $rebounds < 153 AND $lang != 'isr') {$rebounds_dspl = $langmark1588." (18)";}
elseif ($rebounds > 152 AND $rebounds < 161 AND $lang != 'isr') {$rebounds_dspl = $langmark109." (19)";}
elseif ($rebounds >= 161 AND $lang != 'isr') {$rebounds_dspl = $langmark110." (20)";}
...
elseif ($position > 112 AND $position < 121 AND $lang != 'isr') {$position_dspl = $langmark1584." (14)";}
elseif ($position > 120 AND $position < 129 AND $lang != 'isr') {$position_dspl = $langmark1585." (15)";}
elseif ($position > 128 AND $position < 137 AND $lang != 'isr') {$position_dspl = $langmark1586." (16)";}
elseif ($position > 136 AND $position < 145 AND $lang != 'isr') {$position_dspl = $langmark1587." (17)";}
elseif ($position > 144 AND $position < 153 AND $lang != 'isr') {$position_dspl = $langmark1588." (18)";}
elseif ($position > 152 AND $position < 161 AND $lang != 'isr') {$position_dspl = $langmark109." (19)";}
elseif ($position >= 161 AND $lang != 'isr') {$position_dspl = $langmark110." (20)";}
...
elseif ($shooting > 112 AND $shooting < 121 AND $lang != 'isr') {$shooting_dspl = $langmark1584." (14)";}
elseif ($shooting > 120 AND $shooting < 129 AND $lang != 'isr') {$shooting_dspl = $langmark1585." (15)";}
elseif ($shooting > 128 AND $shooting < 137 AND $lang != 'isr') {$shooting_dspl = $langmark1586." (16)";}
elseif ($shooting > 136 AND $shooting < 145 AND $lang != 'isr') {$shooting_dspl = $langmark1587." (17)";}
elseif ($shooting > 144 AND $shooting < 153 AND $lang != 'isr') {$shooting_dspl = $langmark1588." (18)";}
elseif ($shooting > 152 AND $shooting < 161 AND $lang != 'isr') {$shooting_dspl = $langmark109." (19)";}
elseif ($shooting >= 161 AND $lang != 'isr') {$shooting_dspl = $langmark110." (20)";}
...
elseif ($freethrow > 112 AND $freethrow < 121 AND $lang != 'isr') {$freethrow_dspl = $langmark1584." (14)";}
elseif ($freethrow > 120 AND $freethrow < 129 AND $lang != 'isr') {$freethrow_dspl = $langmark1585." (15)";}
elseif ($freethrow > 128 AND $freethrow < 137 AND $lang != 'isr') {$freethrow_dspl = $langmark1586." (16)";}
elseif ($freethrow > 136 AND $freethrow < 145 AND $lang != 'isr') {$freethrow_dspl = $langmark1587." (17)";}
elseif ($freethrow > 144 AND $freethrow < 153 AND $lang != 'isr') {$freethrow_dspl = $langmark1588." (18)";}
elseif ($freethrow > 152 AND $freethrow < 161 AND $lang != 'isr') {$freethrow_dspl = $langmark109." (19)";}
elseif ($freethrow >= 161 AND $lang != 'isr') {$freethrow_dspl = $langmark110." (20)";}
...
elseif ($defense > 112 AND $defense < 121 AND $lang != 'isr') {$defense_dspl = $langmark1584." (14)";}
elseif ($defense > 120 AND $defense < 129 AND $lang != 'isr') {$defense_dspl = $langmark1585." (15)";}
elseif ($defense > 128 AND $defense < 137 AND $lang != 'isr') {$defense_dspl = $langmark1586." (16)";}
elseif ($defense > 136 AND $defense < 145 AND $lang != 'isr') {$defense_dspl = $langmark1587." (17)";}
elseif ($defense > 144 AND $defense < 153 AND $lang != 'isr') {$defense_dspl = $langmark1588." (18)";}
elseif ($defense > 152 AND $defense < 161 AND $lang != 'isr') {$defense_dspl = $langmark109." (19)";}
elseif ($defense >= 161 AND $lang != 'isr') {$defense_dspl = $langmark110." (20)";}
...
elseif ($workrate > 112 AND $workrate < 121 AND $lang != 'isr') {$workrate_dspl = $langmark1584." (14)";}
elseif ($workrate > 120 AND $workrate < 129 AND $lang != 'isr') {$workrate_dspl = $langmark1585." (15)";}
elseif ($workrate > 128 AND $workrate < 137 AND $lang != 'isr') {$workrate_dspl = $langmark1586." (16)";}
elseif ($workrate > 136 AND $workrate < 145 AND $lang != 'isr') {$workrate_dspl = $langmark1587." (17)";}
elseif ($workrate > 144 AND $workrate < 153 AND $lang != 'isr') {$workrate_dspl = $langmark1588." (18)";}
elseif ($workrate > 152 AND $workrate < 161 AND $lang != 'isr') {$workrate_dspl = $langmark109." (19)";}
elseif ($workrate >= 161 AND $lang != 'isr') {$workrate_dspl = $langmark110." (20)";}
...
elseif ($experience > 112 AND $experience < 121 AND $lang != 'isr') {$experience_dspl = $langmark1584." (14)";}
elseif ($experience > 120 AND $experience < 129 AND $lang != 'isr') {$experience_dspl = $langmark1585." (15)";}
elseif ($experience > 128 AND $experience < 137 AND $lang != 'isr') {$experience_dspl = $langmark1586." (16)";}
elseif ($experience > 136 AND $experience < 145 AND $lang != 'isr') {$experience_dspl = $langmark1587." (17)";}
elseif ($experience > 144 AND $experience < 153 AND $lang != 'isr') {$experience_dspl = $langmark1588." (18)";}
elseif ($experience > 152 AND $experience < 161 AND $lang != 'isr') {$experience_dspl = $langmark109." (19)";}
elseif ($experience >= 161 AND $lang != 'isr') {$experience_dspl = $langmark110." (".floor(($experience-1)/8).")";}
...
elseif ($handling > 112 AND $handling < 121 AND $lang == 'isr') {$handling_dspl = "(14) ".$langmark1584;}
elseif ($handling > 120 AND $handling < 129 AND $lang == 'isr') {$handling_dspl = "(15) ".$langmark1585;}
elseif ($handling > 128 AND $handling < 137 AND $lang == 'isr') {$handling_dspl = "(16) ".$langmark1586;}
elseif ($handling > 136 AND $handling < 145 AND $lang == 'isr') {$handling_dspl = "(17) ".$langmark1587;}
elseif ($handling > 144 AND $handling < 153 AND $lang == 'isr') {$handling_dspl = "(18) ".$langmark1588;}
elseif ($handling > 152 AND $handling < 161 AND $lang == 'isr') {$handling_dspl = "(19) ".$langmark109;}
elseif ($handling >= 161 AND $lang == 'isr') {$handling_dspl = "(20) ".$langmark110;}
...
elseif ($speed > 112 AND $speed < 121 AND $lang == 'isr') {$speed_dspl = "(14) ".$langmark1584;}
elseif ($speed > 120 AND $speed < 129 AND $lang == 'isr') {$speed_dspl = "(15) ".$langmark1585;}
elseif ($speed > 128 AND $speed < 137 AND $lang == 'isr') {$speed_dspl = "(16) ".$langmark1586;}
elseif ($speed > 136 AND $speed < 145 AND $lang == 'isr') {$speed_dspl = "(17) ".$langmark1587;}
elseif ($speed > 144 AND $speed < 153 AND $lang == 'isr') {$speed_dspl = "(18) ".$langmark1588;}
elseif ($speed > 152 AND $speed < 161 AND $lang == 'isr') {$speed_dspl = "(19) ".$langmark109;}
elseif ($speed >= 161 AND $lang == 'isr') {$speed_dspl = "(20) ".$langmark110;}
...
elseif ($passing > 112 AND $passing < 121 AND $lang == 'isr') {$passing_dspl = "(14) ".$langmark1584;}
elseif ($passing > 120 AND $passing < 129 AND $lang == 'isr') {$passing_dspl = "(15) ".$langmark1585;}
elseif ($passing > 128 AND $passing < 137 AND $lang == 'isr') {$passing_dspl = "(16) ".$langmark1586;}
elseif ($passing > 136 AND $passing < 145 AND $lang == 'isr') {$passing_dspl = "(17) ".$langmark1587;}
elseif ($passing > 144 AND $passing < 153 AND $lang == 'isr') {$passing_dspl = "(18) ".$langmark1588;}
elseif ($passing > 152 AND $passing < 161 AND $lang == 'isr') {$passing_dspl = "(19) ".$langmark109;}
elseif ($passing >= 161 AND $lang == 'isr') {$passing_dspl = "(20) ".$langmark110;}
...
elseif ($vision > 112 AND $vision < 121 AND $lang == 'isr') {$vision_dspl = "(14) ".$langmark1584;}
elseif ($vision > 120 AND $vision < 129 AND $lang == 'isr') {$vision_dspl = "(15) ".$langmark1585;}
elseif ($vision > 128 AND $vision < 137 AND $lang == 'isr') {$vision_dspl = "(16) ".$langmark1586;}
elseif ($vision > 136 AND $vision < 145 AND $lang == 'isr') {$vision_dspl = "(17) ".$langmark1587;}
elseif ($vision > 144 AND $vision < 153 AND $lang == 'isr') {$vision_dspl = "(18) ".$langmark1588;}
elseif ($vision > 152 AND $vision < 161 AND $lang == 'isr') {$vision_dspl = "(19) ".$langmark109;}
elseif ($vision >= 161 AND $lang == 'isr') {$vision_dspl = "(20) ".$langmark110;}
...
elseif ($rebounds > 112 AND $rebounds < 121 AND $lang == 'isr') {$rebounds_dspl = "(14) ".$langmark1584;}
elseif ($rebounds > 120 AND $rebounds < 129 AND $lang == 'isr') {$rebounds_dspl = "(15) ".$langmark1585;}
elseif ($rebounds > 128 AND $rebounds < 137 AND $lang == 'isr') {$rebounds_dspl = "(16) ".$langmark1586;}
elseif ($rebounds > 136 AND $rebounds < 145 AND $lang == 'isr') {$rebounds_dspl = "(17) ".$langmark1587;}
elseif ($rebounds > 144 AND $rebounds < 153 AND $lang == 'isr') {$rebounds_dspl = "(18) ".$langmark1588;}
elseif ($rebounds > 152 AND $rebounds < 161 AND $lang == 'isr') {$rebounds_dspl = "(19) ".$langmark109;}
elseif ($rebounds >= 161 AND $lang == 'isr') {$rebounds_dspl = "(20) ".$langmark110;}
...
elseif ($position > 112 AND $position < 121 AND $lang == 'isr') {$position_dspl = "(14) ".$langmark1584;}
elseif ($position > 120 AND $position < 129 AND $lang == 'isr') {$position_dspl = "(15) ".$langmark1585;}
elseif ($position > 128 AND $position < 137 AND $lang == 'isr') {$position_dspl = "(16) ".$langmark1586;}
elseif ($position > 136 AND $position < 145 AND $lang == 'isr') {$position_dspl = "(17) ".$langmark1587;}
elseif ($position > 144 AND $position < 153 AND $lang == 'isr') {$position_dspl = "(18) ".$langmark1588;}
elseif ($position > 152 AND $position < 161 AND $lang == 'isr') {$position_dspl = "(19) ".$langmark109;}
elseif ($position >= 161 AND $lang == 'isr') {$position_dspl = "(20) ".$langmark110;}
...
elseif ($shooting > 112 AND $shooting < 121 AND $lang == 'isr') {$shooting_dspl = "(14) ".$langmark1584;}
elseif ($shooting > 120 AND $shooting < 129 AND $lang == 'isr') {$shooting_dspl = "(15) ".$langmark1585;}
elseif ($shooting > 128 AND $shooting < 137 AND $lang == 'isr') {$shooting_dspl = "(16) ".$langmark1586;}
elseif ($shooting > 136 AND $shooting < 145 AND $lang == 'isr') {$shooting_dspl = "(17) ".$langmark1587;}
elseif ($shooting > 144 AND $shooting < 153 AND $lang == 'isr') {$shooting_dspl = "(18) ".$langmark1588;}
elseif ($shooting > 152 AND $shooting < 161 AND $lang == 'isr') {$shooting_dspl = "(19) ".$langmark109;}
elseif ($shooting >= 161 AND $lang == 'isr') {$shooting_dspl = "(20) ".$langmark110;}
...
elseif ($freethrow > 112 AND $freethrow < 121 AND $lang == 'isr') {$freethrow_dspl = "(14) ".$langmark1584;}
elseif ($freethrow > 120 AND $freethrow < 129 AND $lang == 'isr') {$freethrow_dspl = "(15) ".$langmark1585;}
elseif ($freethrow > 128 AND $freethrow < 137 AND $lang == 'isr') {$freethrow_dspl = "(16) ".$langmark1586;}
elseif ($freethrow > 136 AND $freethrow < 145 AND $lang == 'isr') {$freethrow_dspl = "(17) ".$langmark1587;}
elseif ($freethrow > 144 AND $freethrow < 153 AND $lang == 'isr') {$freethrow_dspl = "(18) ".$langmark1588;}
elseif ($freethrow > 152 AND $freethrow < 161 AND $lang == 'isr') {$freethrow_dspl = "(19) ".$langmark109;}
elseif ($freethrow >= 161 AND $lang == 'isr') {$freethrow_dspl = "(20) ".$langmark110;}
...
elseif ($defense > 112 AND $defense < 121 AND $lang == 'isr') {$defense_dspl = "(14) ".$langmark1584;}
elseif ($defense > 120 AND $defense < 129 AND $lang == 'isr') {$defense_dspl = "(15) ".$langmark1585;}
elseif ($defense > 128 AND $defense < 137 AND $lang == 'isr') {$defense_dspl = "(16) ".$langmark1586;}
elseif ($defense > 136 AND $defense < 145 AND $lang == 'isr') {$defense_dspl = "(17) ".$langmark1587;}
elseif ($defense > 144 AND $defense < 153 AND $lang == 'isr') {$defense_dspl = "(18) ".$langmark1588;}
elseif ($defense > 152 AND $defense < 161 AND $lang == 'isr') {$defense_dspl = "(19) ".$langmark109;}
elseif ($defense >= 161 AND $lang == 'isr') {$defense_dspl = "(20) ".$langmark110;}
...
elseif ($workrate > 112 AND $workrate < 121 AND $lang == 'isr') {$workrate_dspl = "(14) ".$langmark1584;}
elseif ($workrate > 120 AND $workrate < 129 AND $lang == 'isr') {$workrate_dspl = "(15) ".$langmark1585;}
elseif ($workrate > 128 AND $workrate < 137 AND $lang == 'isr') {$workrate_dspl = "(16) ".$langmark1586;}
elseif ($workrate > 136 AND $workrate < 145 AND $lang == 'isr') {$workrate_dspl = "(17) ".$langmark1587;}
elseif ($workrate > 144 AND $workrate < 153 AND $lang == 'isr') {$workrate_dspl = "(18) ".$langmark1588;}
elseif ($workrate > 152 AND $workrate < 161 AND $lang == 'isr') {$workrate_dspl = "(19) ".$langmark109;}
elseif ($workrate >= 161 AND $lang == 'isr') {$workrate_dspl = "(20) ".$langmark110;}
...
elseif ($experience > 112 AND $experience < 121 AND $lang == 'isr') {$experience_dspl = "(14) ".$langmark1584;}
elseif ($experience > 120 AND $experience < 129 AND $lang == 'isr') {$experience_dspl = "(15) ".$langmark1585;}
elseif ($experience > 128 AND $experience < 137 AND $lang == 'isr') {$experience_dspl = "(16) ".$langmark1586;}
elseif ($experience > 136 AND $experience < 145 AND $lang == 'isr') {$experience_dspl = "(17) ".$langmark1587;}
elseif ($experience > 144 AND $experience < 153 AND $lang == 'isr') {$experience_dspl = "(18) ".$langmark1588;}
elseif ($experience > 152 AND $experience < 161 AND $lang == 'isr') {$experience_dspl = "(19) ".$langmark109;}
elseif ($experience >= 161 AND $lang == 'isr') {$experience_dspl = "(".round(($experience-1)/8).") ".$langmark110;}
...
if ($ntplayer>0) {echo "&nbsp;<img src=\"img/Flags/",$country,".png\" border=\"0\" alt=\"",$langmark378," ",$country,"\" title=\"",$langmark378," ",$country,"\">";}
echo $prikaz_poskodbe,"<img src=\"",$saledisplay,"\" border=\"0\" alt=\"\"><br/>";
echo $age," ",$langmark379," <a class=\"greenhilite\" href=\"league.php?country=",$country,"\">",$country,"</a>. ",$height;

if ($last_position==10 AND $last_training > 0) {echo "<font color=\"",$barva2,"\">",$weight,"</font><br/>";}
elseif ($last_position==11 AND $last_training > 0) {echo "<font color=\"",$barva1,"\">",$weight,"</font><br/>";}
elseif ($last_position==10 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$weight,"</font><br/>";}
elseif ($last_position==11 AND $last_training < 0){echo "<font color=\"",$barva2,"\">",$weight,"</font><br/>";}
else {echo $weight,"</font><br/>";}
echo $langmark380," ".$spec_txt.". ",$langmark381," ".$wage." &euro; / ",$langmark382,".<br/>";

if ($last_training > 0 AND $last_position <>0 AND $is_supporter==1) {echo "<font color=\"",$barva2,"\">",$langmark257,": +",$last_training,"</font>";}
if ($last_training < 0 AND $is_supporter==1) {echo "<font color=\"",$barva1,"\">",$langmark257,": ",$last_training,"</font>";}
?>
<br/>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr><td width="68"><b><?=$langmark120?>:</b></td><td width="117">
<?php
if ($last_position==1 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$handling_dspl,"</font></td>";}
elseif ($last_position==1 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$handling_dspl,"</font></td>";}
else {echo $handling_dspl,"</font></td>";}

echo "<td width=70><b>",$langmark121,":</b></td><td width=115> ";
if ($last_position==2 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$speed_dspl,"</font></td>";}
elseif ($last_position==2 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$speed_dspl,"</font></td>";}
else {echo $speed_dspl,"</font></td>";}

echo "<tr><td><b>",$langmark122,":</b></td><td> ";
if ($last_position==3 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$passing_dspl,"</font></td>";}
elseif ($last_position==3 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$passing_dspl,"</font></td>";}
else {echo $passing_dspl,"</font></td>";}

echo "<td><b>",$langmark123,":</b></td><td> ";
if ($last_position==4 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$vision_dspl,"</font></td>";}
elseif ($last_position==4 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$vision_dspl,"</font></td>";}
else {echo $vision_dspl,"</font></td>";}

echo "<tr><td><b>",$langmark124,":</b></td><td> ";
if ($last_position==5 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$rebounds_dspl,"</font></td>";}
elseif ($last_position==5 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$rebounds_dspl,"</font></td>";}
else {echo $rebounds_dspl,"</font></td>";}

echo "<td><b>",$langmark125,":</b></td><td> ";
if ($last_position==6 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$position_dspl,"</font></td>";}
elseif ($last_position==6 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$position_dspl,"</font></td>";}
else {echo $position_dspl,"</font></td>";}

echo "<tr><td><b>",$langmark126,":</b></td><td> ";
if ($last_position==7 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$shooting_dspl,"</font></td>";}
elseif ($last_position==7 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$shooting_dspl,"</font></td>";}
else {echo $shooting_dspl,"</font></td>";}

echo "<td><b>",$langmark127,":</b></td><td> ";
if ($last_position==8 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$freethrow_dspl,"</font></td>";}
elseif ($last_position==8 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$freethrow_dspl,"</font></td>";}
else {echo $freethrow_dspl,"</font></td>";}

echo "<tr><td><b>",$langmark128,":</b></td><td> ";
if ($last_position==9 AND $last_training > 0){echo "<font color=\"",$barva2,"\">",$defense_dspl,"</font></td>";}
elseif ($last_position==9 AND $last_training < 0){echo "<font color=\"",$barva1,"\">",$defense_dspl,"</font></td>";}
...
<!-- #$VERSION:2.0 -->
<!-- #$AUTHOR:Tomaz Kranjc -->
<area shape="rect" coords="63,69,87,87" alt="<?=$langmark386?>" title="<?=$langmark386?>" href="players.php?desc=PG" />
<area shape="rect" coords="107,58,132,75" alt="<?=$langmark387?>" title="<?=$langmark387?>" href="players.php?desc=SG" />
<area shape="rect" coords="27,6,49,21" alt="<?=$langmark388?>" title="<?=$langmark388?>" href="players.php?desc=SF" />
<area shape="rect" coords="90,14,113,32" alt="<?=$langmark389?>" title="<?=$langmark389?>" href="players.php?desc=PF" />
<area shape="rect" coords="42,27,60,46" alt="<?=$langmark390?>" title="<?=$langmark390?>" href="players.php?desc=C" />
</map><br/>
<?php
if ($desc == PG) {echo "<b><font color=\"#A30006\">",$langmark386,"</font></b><br/>",$langmark391,"<br/><b>",$langmark396,":</b><br/>",strtolower($langmark120),",",strtolower($langmark122),",",strtolower($langmark128),",",strtolower($langmark121),".<br/><br/>";}
if ($desc == SG) {echo "<b><font color=\"#A30006\">",$langmark387,"</font></b><br/>",$langmark392,"<br/><b>",$langmark396,":</b><br/>",strtolower($langmark126),",",strtolower($langmark123),",",strtolower($langmark128),",",strtolower($langmark121),".<br/><br/>";}
if ($desc == SF) {echo "<b><font color=\"#A30006\">",$langmark388,"</font></b><br/>",$langmark393,"<br/><b>",$langmark396,":</b><br/>",strtolower($langmark126),",",strtolower($langmark125),",",strtolower($langmark128),",",strtolower($langmark122),".<br/><br/>";}
if ($desc == PF) {echo "<b><font color=\"#A30006\">",$langmark389,"</font></b><br/>",$langmark394,"<br/><b>",$langmark396,":</b><br/>",strtolower($langmark125),",",strtolower($langmark124),",",strtolower($langmark128),",",strtolower($langmark122),".<br/><br/>";}
if ($desc == C) {echo "<b><font color=\"#A30006\">",$langmark390,"</font></b><br/>",$langmark395,"<br/><b>",$langmark396,":</b><br/>",strtolower($langmark124),",",strtolower($langmark125),",",strtolower($langmark121),",",strtolower($langmark128),".<br/><br/>";}
?>
...
<a href="players.php?changenow=numbers"><?=$langmark1265?></a> | <a href="totalstats.php"><?=$langmark1264?></a> | <a href="yteam.php">Youth team</a>

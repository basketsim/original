...
$homepg_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$home_pg1 LIMIT 1");
$hpg_name=@mysql_result($homepg_name,0,"name");
$hpg1name=@mysql_result($homepg_name,0,"surname");
$hpg1age=@mysql_result($homepg_name,0,"age");
if ($hpg1age>0) {$hst=$hst+1;}
//$hpg1spe=@mysql_result($homepg_name,0,"speed");
//$hpg1def=@mysql_result($homepg_name,0,"defense");
//$hpg1xp=@mysql_result($homepg_name,0,"experience");
$homesg_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$home_sg1 LIMIT 1");
$hsg_name=@mysql_result($homesg_name,0,"name");
$hsg1name=@mysql_result($homesg_name,0,"surname");
$hsg1age=@mysql_result($homesg_name,0,"age");
if ($hsg1age>0) {$hst=$hst+1;}
//$hsg1spe=@mysql_result($homesg_name,0,"speed");
//$hsg1def=@mysql_result($homesg_name,0,"defense");
//$hsg1xp=@mysql_result($homesg_name,0,"experience");
$homesf_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$home_sf1 LIMIT 1");
$hsf_name=@mysql_result($homesf_name,0,"name");
$hsf1name=@mysql_result($homesf_name,0,"surname");
$hsf1age=@mysql_result($homesf_name,0,"age");
if ($hsf1age>0) {$hst=$hst+1;}
//$hsf1spe=@mysql_result($homesf_name,0,"speed");
//$hsfdef=@mysql_result($homesf_name,0,"defense");
//$hsf1xp=@mysql_result($homesf_name,0,"experience");
$homepf_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$home_pf1 LIMIT 1");
$hpf_name=@mysql_result($homepf_name,0,"name");
$hpf1name=@mysql_result($homepf_name,0,"surname");
$hpf1age=@mysql_result($homepf_name,0,"age");
if ($hpf1age>0) {$hst=$hst+1;}
//$hpf1spe=@mysql_result($homepf_name,0,"speed");
//$hpf1def=@mysql_result($homepf_name,0,"defense");
//$hpf1xp=@mysql_result($homepf_name,0,"experience");
$homec_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$home_c1 LIMIT 1");
$hc_name=@mysql_result($homec_name,0,"name");
$hc1name=@mysql_result($homec_name,0,"surname");
$hc1age=@mysql_result($homec_name,0,"age");
if ($hc1age>0) {$hst=$hst+1;}
//$hc1spe=@mysql_result($homec_name,0,"speed");
//$hc1def=@mysql_result($homec_name,0,"defense");
//$hc1xp=@mysql_result($homec_name,0,"experience");
$awaypg_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$away_pg1 LIMIT 1");
$apg_name=@mysql_result($awaypg_name,0,"name");
$apg1name=@mysql_result($awaypg_name,0,"surname");
$apg1age=@mysql_result($awaypg_name,0,"age");
if ($apg1age>0) {$ast=$ast+1;}
//$apg1spe=@mysql_result($awaypg_name,0,"speed");
//$apg1def=@mysql_result($awaypg_name,0,"defense");
//$apg1xp=@mysql_result($awaypg_name,0,"experience");
$awaysg_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$away_sg1 LIMIT 1");
$asg_name=@mysql_result($awaysg_name,0,"name");
$asg1name=@mysql_result($awaysg_name,0,"surname");
$asg1age=@mysql_result($awaysg_name,0,"age");
if ($asg1age>0) {$ast=$ast+1;}
//$asg1spe=@mysql_result($awaysg_name,0,"speed");
//$asg1def=@mysql_result($awaysg_name,0,"defense");
//$asg1xp=@mysql_result($awaysg_name,0,"experience");
$awaysf_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$away_sf1 LIMIT 1");
$asf_name=@mysql_result($awaysf_name,0,"name");
$asf1name=@mysql_result($awaysf_name,0,"surname");
$asf1age=@mysql_result($awaysf_name,0,"age");
if ($asf1age>0) {$ast=$ast+1;}
//$asf1spe=@mysql_result($awaysf_name,0,"speed");
//$asf1def=@mysql_result($awaysf_name,0,"defense");
//$asf1xp=@mysql_result($awaysf_name,0,"experience");
$awaypf_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$away_pf1 LIMIT 1");
$apf_name=@mysql_result($awaypf_name,0,"name");
$apf1name=@mysql_result($awaypf_name,0,"surname");
$apf1age=@mysql_result($awaypf_name,0,"age");
if ($apf1age>0) {$ast=$ast+1;}
//$apf1spe=@mysql_result($awaypf_name,0,"speed");
//$apf1def=@mysql_result($awaypf_name,0,"defense");
//$apf1xp=@mysql_result($awaypf_name,0,"experience");
$awayc_name = @mysql_query("SELECT name, surname, age, speed, defense, experience FROM players WHERE id=$away_c1 LIMIT 1");
$ac_name=@mysql_result($awayc_name,0,"name");
$ac1name=@mysql_result($awayc_name,0,"surname");
$ac1age=@mysql_result($awayc_name,0,"age");
if ($ac1age>0) {$ast=$ast+1;}
//$ac1spe=@mysql_result($awayc_name,0,"speed");
//$ac1def=@mysql_result($awayc_name,0,"defense");
//$ac1xp=@mysql_result($awayc_name,0,"experience");
...
$ar1 = mysql_query("SELECT arenaname, teamid, seats1+seats2+seats3+seats4 as tseats FROM arena WHERE arenaid ='$arena' LIMIT 1");
$imearene=mysql_result($ar1,0,"arenaname");
$uhlinkja=mysql_result($ar1,0,"teamid");
$tseats=mysql_result($ar1,0,"tseats");
if ($tseats==0) {$tseats=1;}
...
$away_id=$drugaekipa;
//ni reportov
if ($time_tekme>'2012-09-15 12:00:00'){?>
...
//upokojen
if (empty($sur1)) {$sur1="<i>".$langmark759."</i>"; $knof=99;} else {$sur1="<a class=\"greenhilite\" href=\"player.php?playerid=".$sur2."\">".$sur1."</a>"; $knof=0;}
?>
<tr><td bgcolor="#b6deae" class="gborder"><?php if (($ipl1==$sur2 || $ipl2==$sur2 || $ipl3==$sur2 || $ipl4==$sur2 || $ipl5==$sur2) AND $knof<>99) {echo "<img src=\"img/inj.gif\" border=\"0\" height=\"11\" Title=\"Injury\">";}?><?=$sur1?></td>
<td bgcolor="#b6deae" align="center" class="gborder"><?=(2*$two_scoredA+$one_scoredA+$three_scoredA*3)?></td>
<?php if ($two_totalA <> 0) {$kolicnik2 = round(100*$two_scoredA/$two_totalA);}?>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$two_scoredA,"/",$two_totalA,"&nbsp;("?>
<?php if ($two_totalA <> 0) {echo $kolicnik2,"%)</td>";} else {echo " - )</td>";}
if ($three_totalA <> 0) {$kolicnik3 = round(100*$three_scoredA/$three_totalA);}?>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$three_scoredA,"/",$three_totalA,"&nbsp;("?>
<?php if ($three_totalA <> 0) {echo $kolicnik3,"%)</td>";} else {echo " - )</td>";}
if ($one_totalA <> 0) {$kolicnik1 = round(100*$one_scoredA/$one_totalA);}?>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$one_scoredA,"/",$one_totalA,"&nbsp;("?>
<?php if ($one_totalA <> 0) {echo $kolicnik1,"%)</td>";} else {echo " - )</td>";}?>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$def_reboundsA,"+",$off_reboundsA?></td>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$assistsA?></td>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$foulsA?></td>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$stealsA?></td>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$turnoversA?></td>
<td bgcolor="#b6deae" align="center" class="gborder"><?=$blocksA?></td>
...
<td bgcolor="#b6deae" align="center" class="gborder"><b><?=$ratingigralca?></b></td></tr>
...
if ($cou12=='Greece' AND strlen($sur1) > 12) {$sur1 = substr($sur1,0,12); $sur1 = $sur1.".";}
//upokojen
if (empty($sur1)) {$sur1="<i>".$langmark759."</i>"; $knoe=99;} else {$sur1="<a class=\"greenhilite\" href=\"player.php?playerid=".$sur2."\">".$sur1."</a>"; $knoe=0;}
?>
<tr><td bgcolor="#E9967A" class="gborder"><?php if (($ipl1==$sur2 || $ipl2==$sur2 || $ipl3==$sur2 || $ipl4==$sur2 || $ipl5==$sur2) AND $knoe<>99) {echo "<img src=\"img/inj.gif\" border=\"0\" height=\"11\" Title=\"Injury\">";}?><?=$sur1?></td>
...
CASE 19: echo "Youth"; break;
}
echo "<br/>";
}
?>
<br/><a href="cheerleaders.php?squad=<?=$uhlinkja?>"><?=$imearene?></a><hr/>
...
<tr><td align="right" colspan="2"><?php echo "<i>(",round(100*$gled/$tseats),"% of the total capacity)<i>";?></td></tr>
</table>
</td>
</tr>
</table>
...
if ($tip==18 OR $tip==19){?> <span title="<?=$langmark840?>">(<?=number_format(($hpg1age+$hsg1age+$hsf1age+$hpf1age+$hc1age)/$hst,1)?>)</span><?php }?><br/><br/>
...
//$hexp = ($hpg1xp+$hsg1xp+$hsf1xp+$hpf1xp+$hc1xp)/5;
//if ($hexp < 9) {$hexdspl = $langmark111;} elseif ($hexp > 8 AND $hexp < 17) {$hexdspl = $langmark096;} elseif ($hexp > 16 AND $hexp < 25) {$hexdspl = $langmark097;} elseif ($hexp > 24 AND $hexp < 33) {$hexdspl = $langmark098;} elseif ($hexp > 32 AND $hexp < 41) {$hexdspl = $langmark099;} elseif ($hexp > 40 AND $hexp < 49) {$hexdspl = $langmark100;} elseif ($hexp > 48 AND $hexp < 57) {$hexdspl = $langmark101;} elseif ($hexp > 56 AND $hexp < 65) {$hexdspl = $langmark102;} elseif ($hexp > 64 AND $hexp < 73) {$hexdspl = $langmark103;} elseif ($hexp > 72 AND $hexp < 81) {$hexdspl = $langmark104;} elseif ($hexp > 80 AND $hexp < 89) {$hexdspl = $langmark105;} elseif ($hexp > 88 AND $hexp < 97) {$hexdspl = $langmark106;} elseif ($hexp > 96 AND $hexp < 105) {$hexdspl = $langmark107;} elseif ($hexp > 104 AND $hexp < 113) {$hexdspl = $langmark108;} elseif ($hexp > 112 AND $hexp < 121) {$hexdspl = $langmark109;} elseif ($hexp > 120 AND $hexp < 129) {$hexdspl = $langmark110;} else {$hexdspl = $langmark110." (".round(($hexp-1)/8).")";}
//if ($lang=='isr' AND $hexp >= 129) {$hexdspl = "(".round(($hexp-1)/8).") ".$langmark110;}
//echo $langmark130,": ",$hexdspl,"<br/><br/>";
}

}
elseif ($action=='team' AND $hreb > 0) {echo "<br/><br/>";
...
if ($tip==18 OR $tip==19){?> <span title="<?=$langmark840?>">(<?=number_format(($apg1age+$asg1age+$asf1age+$apf1age+$ac1age)/$ast,1)?>)</span><?php }?><br/><br/>
...
//$aexp = ($apg1xp+$asg1xp+$asf1xp+$apf1xp+$ac1xp)/5;
//if ($aexp < 9) {$aexdspl = $langmark111;} elseif ($aexp > 8 AND $aexp < 17) {$aexdspl = $langmark096;} elseif ($aexp > 16 AND $aexp < 25) {$aexdspl = $langmark097;} elseif ($aexp > 24 AND $aexp < 33) {$aexdspl = $langmark098;} elseif ($aexp > 32 AND $aexp < 41) {$aexdspl = $langmark099;} elseif ($aexp > 40 AND $aexp < 49) {$aexdspl = $langmark100;} elseif ($aexp > 48 AND $aexp < 57) {$aexdspl = $langmark101;} elseif ($aexp > 56 AND $aexp < 65) {$aexdspl = $langmark102;} elseif ($aexp > 64 AND $aexp < 73) {$aexdspl = $langmark103;} elseif ($aexp > 72 AND $aexp < 81) {$aexdspl = $langmark104;} elseif ($aexp > 80 AND $aexp < 89) {$aexdspl = $langmark105;} elseif ($aexp > 88 AND $aexp < 97) {$aexdspl = $langmark106;} elseif ($aexp > 96 AND $aexp < 105) {$aexdspl = $langmark107;} elseif ($aexp > 104 AND $aexp < 113) {$aexdspl = $langmark108;} elseif ($aexp > 112 AND $aexp < 121) {$aexdspl = $langmark109;} elseif ($aexp > 120 AND $aexp < 129) {$aexdspl = $langmark110;} else {$aexdspl = $langmark110." (".round(($aexp-1)/8).")";}
//if ($lang=='isr' AND $aexp >= 129) {$aexdspl = "(".round(($aexp-1)/8).") ".$langmark110;}
//echo "<br/>",$langmark130,": ",$aexdspl;

}

}
elseif ($action=='team' AND $areb >0) {echo "<br/><br/>";
...
echo "<hr/><i><font color=\"darkgreen\">Ratings show the maximum ability of your starting 5. But there's no guarantee that they'll perform on that level, matches should always be analysed based on actual stats. Ratings exclude important factors: subs, tactics, daily form, individual quality and contribution based on a playing position.</font></i><hr/>";
}

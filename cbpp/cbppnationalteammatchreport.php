<?
	////////////////////////////////////////////////////////////////////////////////
	// This script is used for CBPP national team match report						
...
$xml	= "<?xml version=\"1.0\"?>
<BasketSimData>
	<FileName>nationalteammatchreport.php</FileName> 
	<Version>1.0</Version> 
	...
	<MatchStatus>$status</MatchStatus>";
		$q	= "SELECT * FROM nt_matchevents WHERE match_id = '$matchid' ORDER BY event_time, event_id";
		$r	= @mysql_query($q, $connect);
		if($r && @mysql_num_rows($r))
		{
			$xml	.= "
